<!-- grandparent of Study Plan validations(to be moved), add/drop requests, LOA requests, and shifting requests -->
<!-- Parent of transactions.blade.php -->
<!-- all styles and JS for parent and children components are here, Entry point of the Livewire -->
<!-- eto lang naiba kasi meron siya options -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
