...
<div>
    <div class="container mt-5">
        <div class="row mb-1">
            <div class="col-md-12">
                <p class="text-first-year"><strong>Student Enlistment</strong>  <button type="button" class="btn btn-primary" style="margin-left: 560px; margin-right: 0px; font-family: Inter, sans-serif;" data-toggle="modal" data-target="#blockCapacityModal">Set Block Capacity</button></p>
                    ...
                    <div class="card-header">
                        ...
                        <div class="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="dropdownMenuButton" style="display: none;">
                            <div class="py-1" role="none">
                                <button class="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100" type="button" data-toggle="modal" data-target="#bulkEditStudentModal" wire:click="selectStudentsForBulkEdit" role="menuitem">Batch Assign</button>
                            </div>
                            <div class="py-1" role="none">
