...
class FirstYearContainer extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.chairperson.student-enlistment.year-containers.first-year-container')->with('students', Student::where('year_level', '1')->paginate($this->perPage));
    }
}
