<div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item menu-open">
                ...
                <li class="nav-item">
                    <a href="/academic_directive/loa_request" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>LOA Request</p>
                    </a>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <br>
        <span style="position: absolute; top: 0.90ch; left: 1ch; font-family: Inter, sans-serif; font-size: 35px; font-weight: bold;">Leave of Absence Request</span>   
            <br><br>
                    ...
                    <div class="panel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input required type="file" required class="custom-file-input" id="exampleInputFile1" onchange="updateLabel('exampleInputFile1')" accept="application/pdf" name="loa_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                            <div class="custom-file">
                                <input required type="file" required class="custom-file-input" id="exampleInputFile2" onchange="updateLabel('exampleInputFile2')" accept="application/pdf" name="letter_of_request">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                            <div class="custom-file">
                                <input required type="file" required class="custom-file-input" id="exampleInputFile3" onchange="updateLabel('exampleInputFile3')" accept="application/pdf" name="note_of_undertaking">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                            <div class="custom-file">
                                <input required type="file" required class="custom-file-input" id="exampleInputFile4" onchange="updateLabel('exampleInputFile4')" accept="application/pdf" name="clearance">
