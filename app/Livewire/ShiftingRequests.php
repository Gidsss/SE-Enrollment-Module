...
class ShiftingRequests extends Component
{
    use WithPagination;
    ...
    {
        $this->totalStudents = ShiftingRequest::count();
    }
    ...
    public function applyBatchUpdate()
    {
        ...
        foreach ($this->bulkEditStudentIds as $studentId) {
            $student = ShiftingRequest::findOrFail($studentId);
            $student->update([
    ...
    public function editStudentData()
    {
        ...
        $student = ShiftingRequest::findOrFail($this->student_edit_id);
    ...
    {
        $student = ShiftingRequest::findOrFail($id);
    ...
    public function render()
        {
            return view('livewire.shifting-requests')->layout('livewire.layouts.student-transactions.transaction-options');
        }
}
