...
<div style="width:1536px; height:auto; background-color: #30349c; position: relative;">
    ...
    <div class="container mt-5">
        <div class="row mb-1">
            <div class="col-md-12">
                <p class="text-first-year"><strong>LOA Requests</strong></p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h5 style="float: left;">Total <strong>#</strong> of Records: {{ $totalStudents }}</h5>
                        ...
                        <button type="button" class="btn btn-primary"style="float: right;" data-toggle="modal" data-target="#bulkEditStudentModal2" wire:click="selectStudentsForBatchUpdate">Batch Update</button>
                    </div>
