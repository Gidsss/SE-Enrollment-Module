        ...
        <div id="right-card">
            <div id="livewire-component-container">
                <div id="first-year-container" class="livewire-component"  style="display: none;">
                    <livewire:chairperson.student-enlistment.year-containers.first-year-container />
                </div>
                <div id="second-year-container" class="livewire-component" style="display: none;">
                <livewire:chairperson.student-enlistment.year-containers.second-year-container />
                </div>
                <div id="third-year-container" class="livewire-component" style="display: none;">
                <livewire:chairperson.student-enlistment.year-containers.third-year-container />
                </div>
                <div id="fourth-year-container" class="livewire-component" style="display: none;">
                <livewire:chairperson.student-enlistment.year-containers.fourth-year-container />                 
                </div>
            </div>
        </div>
