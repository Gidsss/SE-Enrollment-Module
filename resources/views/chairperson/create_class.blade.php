...
<style>
    ...
    <!-- <div class="card" style="width:13.03in; height:10ch; background-color: #2D349A; position: relative;"> -->
        ...
        <div style="max-width:100%; height:50px; background-color: #e0dcdc; position: relative;">
            <br><br><br>
            <a href="" style="text-decoration: none;">
                <span style="color: black; position: absolute; top: 26%; left: 10%; font-family: Inter, sans-serif; font-size: 16px; font-weight: bold; cursor: pointer;">Schedules</span>
            </a>
            <a href="" style="text-decoration: none;">
                <span style="color: black; position: absolute; top: 26%; left: 35%; font-family: Inter, sans-serif; font-size: 16px; font-weight: bold; cursor: pointer;">Student Records</span>
            </a>
            <a href="" style="text-decoration: none;">
                <span style="color: black; position: absolute; top: 26%; left: 60%; font-family: Inter, sans-serif; font-size: 16px; font-weight: bold; cursor: pointer;">Enrollment</span>
            </a>
            <a href="" style="text-decoration: none;">
                <span style="color: black; position: absolute; top: 26%; left:85%; font-family: Inter, sans-serif; font-size: 16px; font-weight: bold; cursor: pointer;">Print Forms</span>
            </a>
        </div>
