...
<div class="container mt-5">
        <div class="row mb-1">
            <div class="col-md-12">
            <p class="text-first-year"><strong>Student Enlistment</strong>  <button type="button" class="btn btn-primary" style="margin-left: 560px; margin-right: 0px; font-family: Inter, sans-serif;" data-toggle="modal" data-target="#blockCapacityModal3">Set Block Capacity</button></p>            
        </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                        <p style="float: left; font-family: Inter, sans-serif; margin-top: 5px;" >Total <strong>#</strong> of Records: {{ $fourthYearStudents }}</p>
                        ...
                        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton3" aria-haspopup="true" aria-expanded="false" style="font-family: Inter, sans-serif;">
                            Assign Button
                        </button>
                        <div class="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="dropdownMenuButton" style="display: none;">
                            <div class="py-1" role="none">
                                <button class="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100" type="button" data-toggle="modal" data-target="#bulkEditStudentModal3" wire:click="selectStudentsForBulkEdit" role="menuitem">Batch Assign</button>
                            </div>
                            <div class="py-1" role="none">
    ...
    <!-- Modals -->
    <div wire:ignore.self class="modal fade" id="editStudentModal3" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    ...
    <div wire:ignore.self class="modal fade" id="deleteStudentModal3" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Batch Assign Modal -->
    <div wire:ignore.self class="modal fade" id="bulkEditStudentModal3" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="blockCapacityModal3" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="blockCapacityModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" wire:click="saveCommonBlockCapacity(4)">Save</button>
            </div>
        </div>
    </div>
</div>
