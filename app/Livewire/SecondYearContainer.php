...
class SecondYearContainer extends Component
{
    use WithPagination;
    ...
    public function getPaginatedStudentsByName($orderByDirection, $offset)
        {
            ...
            return Student::where('year_level', '2')
    ...
    public function assignBlockSectionsAlphabetically()
    {
        ...
        $students = Student::where('year_level', '2')->orderBy('student_name')->get();
    ...
    public function assignBlockSectionsRandomly()
    {
        ...
        $students = Student::where('year_level', '2')->get();
    ...
    public function render()
        {
            return view('livewire.second-year-container')
                ->layout('livewire.layouts.chairperson')
                ->with('students', Student::where('year_level', '2')->paginate($this->perPage));
        }
}
