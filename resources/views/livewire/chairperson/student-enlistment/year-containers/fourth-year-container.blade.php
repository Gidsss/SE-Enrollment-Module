        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h5 style="float: left;">Total <strong>#</strong> of Records: {{ $fourthYearStudents }}</h5>
                        <button type="button" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#bulkEditStudentModal3" wire:click="selectStudentsForBulkEdit">Batch Assign</button>
                        ...
                        <button type="button" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#blockCapacityModal3">Set Block Capacity</button>
                    </div>
