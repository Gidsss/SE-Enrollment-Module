...
@section('content')
    ...
    <style>
        ...
        .studyPlanModal { /* Target the modal itself */
            overflow-x: hidden; /* Hide horizontal overflow */
            overflow-y: hidden; /* Hide horizontal overflow */
            max-width: 100%; /* Allow full width within the viewport */
        }

        .modal-content { /* Target the modal content */
            overflow-x: hidden; /* Hide horizontal overflow */
            overflow-y: hidden; /* Hide horizontal overflow */
        ...
        .underline-container:after {
            ...
            bottom: -2px; /* Adjust position for alignment */
            left: 0;
        }
    ...
    <div class="content-wrapper">
        ...
        <br>
        <span style="position: absolute; top: 0.90ch; left: 1ch; font-family: Inter, sans-serif; font-size: 35px; font-weight: bold;">Shifting of Courses</span>   
            <br><br>
    ...
    <div class="container-fluid">
        ...
        <div class="card" style="max-width: 100%; height: 250ch; color: #2D349A; position: relative;">
            ...
            <section class="content">
                ...
                <i class="fas fa-check-circle step-checkmark" style="font-size: 27px;"></i>
                    ...
                    <div class="panel">
                        <br>
                            <p style="font-family: Inter, sans-serif; font-size: 24px; color:black; font-weight:bold">Curriculum Checklist</p>
                            ...
                            <div class="center-button">
                                <button type="button" class="btn" style="background-color: #C9AE5D; color: #535353;" onclick="proceedToNextStep(2)">Download Checklist and Proceed to Study Plan</button>
                            </div>
                ...
                <i class="fas fa-check-circle step-checkmark" style="font-size: 27px;"></i>
                    ...
                    <p class="body-font">&nbsp;&nbsp;g. Underloaded units should also be verified by the college chairperson to ensure compliance with program requirements.</p>
                        <div class="center-button">
                            <button type="button" class="btn" style="background-color: #C9AE5D; color: #535353; width:34.5ch;" onclick="openStudyPlanModal()">Create Your Study Plan</button>
                        </div>
                        <br>
                        <div class="center-button">
            ...
            <div class="card custom-table-container">
                ...
                <i class="fas fa-check-circle step-checkmark" style="font-size: 27px;"></i>
                    ...
                    <div class="panel">
                        <br>
                        <button type="submit" type="button"  onclick="proceedToNextStep(4)" class="btn btn-primary float-right" style="color: #2D349A; position: relative; bottom: 0px; left: 5px; width: 120px; height: 4ch;">
                            ...
                            <div id="course-data-container"></div>
                    </div>
            ...
            <!-- Modal Content for Studyplan -->
            <div id="studyPlanModal" class="modal studyplan">
                <div class="modal-content studyplan">
                    <span class="close" onclick="closeStudyPlanModal()">&times;
                    </span>
        ...
        document.addEventListener('livewire:load', function () {
            Livewire.on('showData', function () {
                const container = document.getElementById('course-data-container');
                // Directly call the component's render method using Livewire.emit
                container.innerHTML = Livewire.emit('render');
            });
        });
        ...
        window.onclick = function(event) {
            var modal = document.getElementById('studyPlanModal');
