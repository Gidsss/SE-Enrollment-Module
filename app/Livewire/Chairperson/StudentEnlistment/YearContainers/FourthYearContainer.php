...
class FourthYearContainer extends Component
{
    ...
    public function getPaginatedStudents($page = null)
    {
        ...
        $query = Student::where('year_level', '4');
    ...
    public function assignBlockSectionsRandomly()
    {
        ...
        $students = Student::where('year_level', '4')->get()->shuffle();
    ...
    public function render()
    {
        ...
        return view('livewire.chairperson.student-enlistment.year-containers.fourth-year-container', [
            'students' => $students,
