        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document" style="max-width:80%">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="reason" class="col-3" style="color: darkred;">Reason:</label>
                    ...
                    <div class="form-group row justify-content-center">
                        <button wire:click="changeColor('adddrop')" class="btn btn-sm @if($activeButton === 'adddrop') btn-primary @else btn-outline-dark @endif font-weight-bold mr-2">Review Add Drop Form</button>
                    ...
                    @if ($hasAddDrop)
                        <div>
                            ...
                            @else
                                <p>No Added Classes</p>
                            @endif

                            <h3>Dropped Classes</h3>
